...
public class PlayerCharacter {
    ...
    @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, orphanRemoval = true)
    //@JoinColumn(name="player_character_id", referencedColumnName = "id")
    ...
    public PlayerCharacter(String name, String description, int crit_range, double attack_mod, int num_of_attacks, boolean has_adv, List<Dice> standard_die_list, int standard_dam_mod,
        ...
        //this.piercer_param = piercer_param;
        if (piercer_check) {
        ...
        //this.piercer_param_gwf = piercer_param_gwf;
        ...
        //this.piercer_param_bonus = piercer_param_bonus;
        ...
        //this.piercer_param_gwf_bonus = piercer_param_gwf_bonus;
